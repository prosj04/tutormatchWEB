...
| [MARKETING_PLAN.md](MARKETING_PLAN.md) | 마케팅 실행 계획 v2 — 4트랙(학생→학부모→강사→매니저) 채널 매트릭스·예산·90일 캘린더 + 상세 플레이북 §10~21(숏폼 스크립트·SEO 키워드 맵·검색광고 구조·CRM 실문구·설명회 식순·후기 루프·시즌 캠페인·CRO·채용 공고 전문·위기 SOP) |
