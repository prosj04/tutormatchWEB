...
const MANAGER_NAV: PortalNavItem[] = [
  ...
  {
    href: "/teacher-portal/dashboard/approval",
    label: "선생님 승인",
    prefix: true,
    icon: <svg viewBox="0 0 24 24" {...stroke}><path d="M9 11l3 3L22 4" /><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11" /></svg>,
  },
];
