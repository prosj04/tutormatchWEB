          ...
          >
            ...
            <section style={sectionStyle}>
              ...
              <p>
                ...
                해지 시 이미 진행된 수업 시간의 정가를 결제 금액에서 공제한 후
                잔액을 환불해 드립니다. 진행분 공제의 기준 정가는{" "}
                <strong>시간당 50,000원</strong>입니다.
              </p>
              <ul style={listStyle}>
                <li>공제 금액 = 진행된 수업 시간(시간) × 50,000원</li>
                <li>진행된 수업 시간은 시스템에 기록된 완료 수업 기준으로 산정합니다.</li>
              </ul>
              ...
              <div style={calloutStyle}>
                ...
                <p>
                  고등 · 주 2회 · 회당 2시간(월 16시간) 월정액 780,000원 상품을
                  결제하고, 3회(6시간) 수업을 진행한 뒤 해지를 요청한 경우:
                </p>
                <ul style={listStyle}>
                  <li>결제 금액: <strong>780,000원</strong> (월정액)</li>
                  <li>진행분 공제: 6시간 × 50,000원 = <strong>300,000원</strong></li>
                  <li>
                    환불 금액: 780,000원 − 300,000원 =
