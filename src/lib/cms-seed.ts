...
const siteContentDefaults = [
  { section: "hero", key: "headline", value: "맞는 선생님 한 명이\n아이의 성적을 바꿉니다", type: "text", order: 1 },
  { section: "hero", key: "subtext", value: "SKY·의치한약수 출신 중에서도 엄선된 선생님만 배정합니다. 전담 매니저가 성향·목표·일정을 직접 듣고 처음부터 딱 맞는 선생님을 연결해 드립니다.", type: "text", order: 2 },
  { section: "hero", key: "cta_primary", value: "지금 무료 상담 신청하기", type: "text", order: 3 },
  { section: "hero", key: "cta_secondary", value: "선생님 둘러보기", type: "text", order: 4 },
  { section: "hero", key: "bg_image_url", value: "", type: "image", order: 5 },
  { section: "hero", key: "trust_text", value: "✓ 첫 수업 100% 환불 보장 · ✓ 1~3일 내 선생님 배정", type: "text", order: 6 },

  { section: "stats", key: "stat1_number", value: "2명 중 1명", type: "number", order: 1 },
  { section: "stats", key: "stat1_label", value: "3개월 내 성적 향상", type: "text", order: 2 },
  { section: "stats", key: "stat2_number", value: "1,200+", type: "number", order: 3 },
  { section: "stats", key: "stat2_label", value: "누적 매칭 완료", type: "text", order: 4 },
  { section: "stats", key: "stat3_number", value: "97%+", type: "number", order: 5 },
  { section: "stats", key: "stat3_label", value: "수강 만족도", type: "text", order: 6 },
  ...
  { section: "features", key: "section_subtext", value: "상담부터 배정까지 빠르면 2일, 첫 수업은 마음에 안 들면 100% 환불됩니다.", type: "text", order: 2 },
  { section: "features", key: "step1_title", value: "무료 상담 신청 (30초)", type: "text", order: 3 },
  { section: "features", key: "step1_desc", value: "학생의 성적, 목표, 성향을 간단히 남겨주세요. 30초면 충분합니다.", type: "text", order: 4 },
  { section: "features", key: "step2_title", value: "당일 매니저 연락", type: "text", order: 5 },
  { section: "features", key: "step2_desc", value: "전담 매니저가 1:1로 전화 상담을 진행합니다. 걱정되시는 점을 자세히 들어드립니다.", type: "text", order: 6 },
  { section: "features", key: "step3_title", value: "1~3일 내 선생님 추천", type: "text", order: 7 },
  { section: "features", key: "step3_desc", value: "상담 내용 바탕으로 과목·성향·일정에 딱 맞는 선생님 후보를 추천합니다.", type: "text", order: 8 },
  { section: "features", key: "step4_title", value: "첫 수업 · 100% 환불 보장", type: "text", order: 9 },
  { section: "features", key: "step4_desc", value: "첫 수업 후 불만족 시 어떠한 위약금 없이 전액 환불해 드립니다.", type: "text", order: 10 },
  { section: "features", key: "step5_title", value: "학습 리포트 & 지속 관리", type: "text", order: 11 },
  { section: "features", key: "step5_desc", value: "진도·숙제·질문·월간 리포트를 한 흐름으로 계속 관리합니다.", type: "text", order: 12 },
  ...
  { section: "teachers", key: "section_title", value: "지원자 절반이 탈락하는\n검증을 통과한 선생님들", type: "text", order: 1 },
  { section: "teachers", key: "section_subtext", value: "SKY·의치한약수 출신만 지원 가능하며, 서류·수업 시연·최종 면접을 모두 통과한 선생님만 배정합니다.", type: "text", order: 2 },
  ...
  { section: "management", key: "headline", value: "선생님께 직접 말 못해도\n매니저가 다 챙겨드립니다", type: "text", order: 1 },
  { section: "management", key: "subtext", value: "불편한 요청도 매니저가 대신 전달합니다. 학부모님은 수업 내용·숙제·성적 변화를 한 화면에서 확인하세요.", type: "text", order: 2 },
  { section: "management", key: "item1_title", value: "수업 후 리포트", type: "text", order: 3 },
  { section: "management", key: "item1_desc", value: "매 수업마다 학습 내용과 숙제를 정리해 학부모님께 전달합니다.", type: "text", order: 4 },
  { section: "management", key: "item2_title", value: "선생님 교체도 간단하게", type: "text", order: 5 },
  { section: "management", key: "item2_desc", value: "맞지 않으면 매니저에게 말씀만 해주세요. 선생님께 직접 말하지 않아도 됩니다.", type: "text", order: 6 },
  { section: "management", key: "item3_title", value: "취약점 분석 리포트", type: "text", order: 7 },
  { section: "management", key: "item3_desc", value: "월간 학습 데이터와 취약 유형을 분석해 리포트로 제공합니다.", type: "text", order: 8 },
