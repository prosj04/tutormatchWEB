...
const siteContentDefaults = [
  ...
  { section: "features", key: "step1_desc", value: "학생의 현재 성적, 목표, 성향을 간단히 남겨주세요. 30초면 매니저가 연락드립니다.", type: "text", order: 4 },
  { section: "features", key: "step2_title", value: "매니저 학습 상담 및 선생님 배정", type: "text", order: 5 },
  { section: "features", key: "step2_desc", value: "매니저가 직접 방문해 학습 상태를 진단하고, 상담에서 파악한 성향에 꼭 맞는 선생님을 배정합니다.\n학생이 수락하면 첫 수업 날짜를 확정하고 수업을 시작합니다.", type: "text", order: 6 },
  { section: "features", key: "step3_title", value: "수업 관리 (숙제·질문)", type: "text", order: 7 },
  { section: "features", key: "step3_desc", value: "선생님이 앱에서 숙제를 내면 학생이 매일매일 체크합니다.\n질문을 남기면 최고 성능의 질의응답 전용 AI가 즉시 답하고, 이어서 선생님 답변까지 받아볼 수 있습니다.", type: "text", order: 8 },
  { section: "features", key: "step4_title", value: "리포트 & 학부모 앱", type: "text", order: 9 },
  { section: "features", key: "step4_desc", value: "매 수업 후 수업 리포트, 매월 상세한 월간 리포트를 제공합니다.\n학부모 앱에서 수업·숙제·진도를 언제든 확인하실 수 있습니다.", type: "text", order: 10 },
  { section: "features", key: "step5_title", value: "매니저 사후 관리", type: "text", order: 11 },
  { section: "features", key: "step5_desc", value: "배정 이후에도 매니저가 상시 관리합니다.\n선생님이 맞지 않는다면 언제든 비용 없이 재매칭하고, 언제든 매니저 상담을 요청하실 수 있습니다.", type: "text", order: 12 },
  { section: "features", key: "step1_image", value: "/images/photos/scenes/scene-1.jpg", type: "image", order: 13 },
  { section: "features", key: "step2_image", value: "/images/photos/scenes/scene-2.jpg", type: "image", order: 14 },
  { section: "features", key: "step3_image", value: "/images/photos/scenes/scene-3.jpg", type: "image", order: 15 },
  { section: "features", key: "step4_image", value: "/images/photos/scenes/scene-4.jpg", type: "image", order: 16 },
  { section: "features", key: "step5_image", value: "/images/photos/scenes/scene-5.jpg", type: "image", order: 17 },
  ...
  { section: "features", key: "step6_desc", value: "", type: "text", order: 25 },
  {
    section: "features",
    key: "step6_image",
    value: "/images/photos/scenes/scene-6.jpg",
    type: "image",
    order: 26,
  },
...
const testimonialDefaults = [
  {
    ...
    author: "고2 수학 · 학부모",
    imageUrl: "/images/photos/selfies/selfie-1.jpg",
    order: 1,
  },
  {
