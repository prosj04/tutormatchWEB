...
const siteContentDefaults = [
  ...
  { section: "cta", key: "cta_box_2_title", value: "매니저 직접 배정", type: "text", order: 15 },
  { section: "cta", key: "cta_box_2_desc", value: "전문 매니저가 처음부터 함께합니다.", type: "text", order: 16 },
  {
    section: "cta",
    key: "cta_box_2_detail",
    value: "수업 외에도 진도·숙제·질문을 챙기며 학부모님께도 정기적으로 공유합니다.",
    type: "text",
    order: 17,
  },
  { section: "cta", key: "cta_box_3_visible", value: "1", type: "text", order: 18 },
  { section: "cta", key: "cta_box_3_title", value: "학습 리포트 무료", type: "text", order: 19 },
  { section: "cta", key: "cta_box_3_desc", value: "첫 달 학습 리포트를 무료로 제공합니다.", type: "text", order: 20 },
  {
    section: "cta",
    key: "cta_box_3_detail",
    value: "출결, 과제 수행률, 취약 단원을 한눈에 볼 수 있는 리포트를 받아보세요.",
    type: "text",
    order: 21,
  },
  { section: "cta", key: "cta_box_4_visible", value: "1", type: "text", order: 22 },
  { section: "cta", key: "cta_box_4_title", value: "맞춤 강사 매칭", type: "text", order: 23 },
  { section: "cta", key: "cta_box_4_desc", value: "성향과 목표에 맞는 선생님을 연결합니다.", type: "text", order: 24 },
  {
    section: "cta",
    key: "cta_box_4_detail",
    value: "무작위 배정이 아니라 상담 내용을 바탕으로 후보를 추천하고 일정까지 조율합니다.",
    type: "text",
    order: 25,
  },
