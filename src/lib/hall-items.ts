/** 합격 카드 기본 데이터 — 학교 로고 워터마크 + 브랜드 컬러 텍스트. 2과목 수강 비중 30%(10명 중 3명). */
export const HALL_DEFAULT_CARDS = [
  ...
  { logo: "/images/logos/univ/korea.png", color: "#8C0021", title: "고려대학교 합격", dept: "미디어학부", student: "이*준", course: "2년간 국어 수강" },
  { logo: "/images/logos/univ/skku.png", color: "#0B6E4F", title: "성균관대학교 합격", dept: "글로벌경영학과", student: "박*서", course: "1년간 영어 수강" },
  { logo: "/images/logos/univ/hanyang.png", color: "#0E4A84", title: "한양대학교 합격", dept: "기계공학부", student: "정*원", course: "2년간 수학·과학 수강" },
  { logo: "/images/logos/univ/ewha.png", color: "#00584A", title: "이화여자대학교 합격", dept: "초등교육과", student: "최*아", course: "3년간 국어 수강" },
  ...
  { logo: "/images/logos/univ/konkuk.png", color: "#036B3F", title: "건국대학교 합격", dept: "수의예과", student: "한*수", course: "2년간 수학 수강" },
  { logo: "/images/logos/univ/dongguk.png", color: "#E17000", title: "동국대학교 합격", dept: "경찰행정학부", student: "서*현", course: "2년간 사회 수강" },
] as const;
