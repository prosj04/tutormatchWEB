    ...
    <section className="bg-navy px-6 py-24 md:py-32">
      <FadeSection className="mx-auto max-w-2xl text-center">
        ...
        <Link
          ...
          className="mt-10 inline-flex items-center justify-center rounded-2xl bg-gold px-12 py-4 text-lg font-semibold text-navy shadow-lg transition hover:bg-gold/90"
        >
          무료 상담 예약하기
        </Link>
      </FadeSection>
