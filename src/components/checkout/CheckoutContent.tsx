      ...
      <div className="mx-auto max-w-6xl px-8 py-12 md:py-16">
        <div className="mb-10">
          <Link
            ...
            className="text-xs font-semibold uppercase tracking-wider text-text-light underline-offset-4 transition hover:text-primary hover:underline"
          >
        ...
        <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,26rem)] lg:items-start lg:gap-16">
          <div className="space-y-10">
            <section className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
              ...
              <dl className="mt-6 space-y-4 text-sm">
                <div className="flex justify-between gap-4 border-b border-gray-100 pb-4">
                  <dt className="text-text-mid">플랜</dt>
                  <dd className="font-semibold text-text-dark">{PLAN_LABEL[sessions]}</dd>
                </div>
                <div className="flex justify-between gap-4 border-b border-gray-100 pb-4">
                  <dt className="text-text-mid">강사</dt>
                  <dd className="font-semibold text-text-dark">{tutorName}</dd>
                </div>
                <div className="flex justify-between gap-4 border-b border-gray-100 pb-4">
                  <dt className="text-text-mid">플랫폼 이용료</dt>
                  <dd className="text-text-dark">{formatKRW(platformFee)}</dd>
                </div>
                <div className="flex justify-between gap-4 border-b border-gray-100 pb-4">
                  <dt className="text-text-mid">수업료</dt>
                  <dd className="text-text-dark">{formatKRW(lessonFee)}</dd>
                </div>
                <div className="flex justify-between gap-4 pt-2">
                  <dt className="text-lg font-black text-text-dark">총 결제금액</dt>
            ...
            <section className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
              <h2 className="text-xl font-black text-text-dark">결제 수단</h2>
          ...
          <div className="space-y-8">
            <section className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
              <h2 className="text-xl font-black text-text-dark">주문자 정보</h2>
              <div className="mt-6 space-y-5">
                <div>
                  <label
                    htmlFor="checkout-name"
                    className="text-xs font-semibold uppercase tracking-wider text-text-light"
                  >
                    이름
                  </label>
                  <input
                    ...
                    className="mt-2 w-full rounded-xl border border-gray-200 bg-background px-4 py-3 text-sm text-text-dark outline-none transition focus:border-primary"
                  />
                </div>
                <div>
                  <label
            ...
            <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
              ...
              {!widgetReady && !error ? (
                <p className="mt-3 text-center text-xs text-text-light">결제 UI를 불러오는 중…</p>
              ) : null}
            </div>
          </div>
        </div>
